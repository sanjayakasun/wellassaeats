    ...
    <nav class="navbar navbar-dark navbar-expand-md bg-dark py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><img class="navbar-logo"
            ...
            <button data-bs-toggle="collapse"
                    class="navbar-toggler" data-bs-target="#navcol-5"><span
            ...
            <div class="collapse navbar-collapse" id="navcol-5">
                ...
                <a class="btn btn-primary ms-md-2 btn-all" role="button" href="profile.php"
                   style="background: var(--bs-warning);">Hi <?php echo $user_name; ?></a>
            </div>
        </div>
    </nav><!-- End: Navbar Right Links (Dark) -->
</div>
<div class="container1" style="background: url(assets/img/bg3.jpg); background-size: cover; background-repeat: no-repeat; background-position: center bottom">
    <div class="profile">
        <?php
        ...
        <a href="edit-profile.php" class="btn1">Update & Explore</a>
        <a href="logout.php" class="btn1">Log out</a>
        <p>new <a href="login.php">Log in</a> or <a href="signup.php">Sign up</a></p>
    </div>
</div>

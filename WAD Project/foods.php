    ...
    <nav class="navbar navbar-expand-md bg-dark py-3 navbar-dark">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><img class="navbar-logo" src="assets/img/logo.png" style="width: 5rem;padding: 0.5rem;"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-5"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-5">
                ...
                </ul><a class="btn btn-primary ms-md-2 btn-all" role="button" href="login.html" style="background: var(--bs-warning);">Login</a>
            </div>
        </div>
    </nav>
</div>
...
<div class="menu-container">
    ...
    <div class="menu-card">
        ...
        <div class="menu-card__footer">
            ...
            <label  hidden> <?php echo $items->menu_item_id ?></label>
...
//        foreach ($user as $items){
//        ?>
<!--        <div class="col-md-4" style="background: var(--bs-border-color-translucent);padding: 10px;">-->
<!--            <div style="background: var(--bs-secondary-text-emphasis);border-radius: 14px;">-->
<!--                <div class="row" id="Restaurant-image-row" style="text-align: center;">-->
<!--                    <div class="col"><img src="--><?php //echo $items->menu_item_picture?><!--"-->
<!--                                          style="width: 13rem;margin: 4px;border-radius: 21px;padding: 12px;margin-right: 0px;margin-left: 0px;">-->
<!--                    </div>-->
<!--                </div>-->
<!--                <div class="row" style="text-align: center;">-->
<!--                    <div class="col">-->
<!--                        <h1 style="color: var(--bs-body-bg);font-size: 17.5px;margin: 6px;padding: 5px;">--><?php //echo $items->menu_item_name?><!--</h1>-->
<!--                        <h3 style="color: var(--bs-body-bg);font-size: 14.5px;margin: 6px;padding: 5px;">Rs.--><?php //echo $items->menu_item_price?><!--</h3>-->
<!--                    </div>-->
<!--                </div>-->
<!--                <div class="row" style="text-align: center;">-->
<!--                    <div class="col"><a class="btn btn-primary ms-md-2" role="button" id="show-foods" href="foods.html"-->
<!--                                        style="background: var(--bs-warning);margin: 8px;padding: 7px 14px;margin-bottom: 19px;">Add to Cart</a></div>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--            --><?php

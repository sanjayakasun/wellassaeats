...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    if(isset($_POST["submit"])){
        ...
        header("Location: signup.php?message=3"); //show error message as Please click the 'Sign Up' button to complete the Signup process!
    exit;
    }
} else{
    header("Location: signup.php?message=2"); //show error message as Invalid Request Method!
    exit;
}
?>
